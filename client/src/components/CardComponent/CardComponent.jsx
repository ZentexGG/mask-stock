    ...
    return (
        <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
                ...
                <Card.Text>
                    Delivered and packaged with care by passenger trains at CFR
                    Calatori. Please excuse us for the 99% delayed orders, we
                    are doing the best we can.
                </Card.Text>
                <Form.Control
                    onChange={handleChange}
                    value={value}
                    placeholder="Input ammount of boxes..."></Form.Control>
